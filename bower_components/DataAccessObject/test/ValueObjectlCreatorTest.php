<?php
	...
	require_once "../ValueObjectCreator.php";
	require_once "../ValueObject.php";
	use Dansnet\DataAccessObject;
	use Dansnet\ValueObjectCreator;
	
	class ValueObjectCreatorTest extends PHPUnit_Framework_TestCase {
		 ...
		 */
		public function testValueObject( Dansnet\DatabaseConnector $database ) {
			...
			$creator = new ValueObjectCreator($database, "models");
